<template>
    <div class="inbox-body">
        <div class="mail-option">
            ...
            <button class="btn btn-danger" @click="data.message.isDeleted = true"
            ...
            <button class="btn btn-info" @click="data.message.isRead = false"
                    :disabled="!data.message.isRead">
                <i class="fa fa-envelope-open" aria-hidden="true"></i>
                &nbsp; Mark as unread
            </button>

            <button class="btn btn-default" @click="data.message.isRead = true"
                    :disabled="data.message.isRead">
                <i class="fa fa-envelope-open" aria-hidden="true"></i>
                &nbsp; Mark as read
            </button>
